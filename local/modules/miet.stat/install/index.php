...
Битрикс CModule*/
Class miet_stat extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "miet.stat";
    var $MODULE_ID = "miet.stat";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("miet.stat_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("miet.stat_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("miet.stat_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("miet.stat_PARTNER_URI");
    }
