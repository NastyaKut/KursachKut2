...
class STATBrandsTable extends Entity\DataManager
{
    ...
    public static function getMap()
    {
        return array(
            ...
            'UF_BRAND' => array(
                ...
                'title' => Loc::getMessage('STAT_ENTITY_UF_BRAND_FIELD')
            ),
            'UF_VALUE' => array(
                'data_type' => 'float',
                'required' => true,
                ...
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_VALUE_FIELD')
            ),
            'UF_BRANDS' => array(
                'data_type' => 'integer',
                'required' => true,
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_BRANDS_FIELD')
            ),
            'UF_CREATED_BY' => array(
                'data_type' => 'integer',
                'required' => true,
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_CREATED_BY_FIELD')
            ),
            'UF_CREATED' => array(
                'data_type' => 'datetime',
                'required' => true,
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_CREATED_FIELD')
            ),
            'UF_CHANGED_BY' => array(
                'data_type' => 'integer',
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_CHANGED_BY_FIELD')
            ),
            'UF_CHANGED' => array(
                'data_type' => 'datetime',
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_CHANGED_FIELD'),
            ),
            'UF_PERIOD' => array(
                'data_type' => 'date',
                'title' =>
                    Loc::getMessage('STAT_ENTITY_UF_PERIOD_FIELD'),
            ),
            //Описываем все связи с другими таблицами (внешние ключи)
            new Entity\ReferenceField(
                'UF_BRAND',
                'Bitrix\Iblock\ElementTable',
                array('=this.UF_BRAND' => 'ref.ID')
            ),
            new Entity\ReferenceField(
                'UF_BRANDS',
                'Bitrix\Iblock\SectionElementTable',
                array('=this.UF_BRANDS' => 'ref.ID')
            ),
            new Entity\ReferenceField(
                'UF_CREATED_BY',
